@push('stylesheet')
  <link rel="stylesheet" href="{{ asset('css/kategori-page.css') }}">
@endpush
...
<div class="kategori-page">
    ...
    <section class="content container">
      ...
      <div class="card">
        ...
        <form wire:submit.prevent='store_category' class="card-body">
          ...
          <div class="input-group">
            <input wire:model='description' type="text" class="form-control" placeholder="Deskripsi kategori">
            @error('description')
              <small class="error">{{ $message }}</small>
            @enderror
          </div>
